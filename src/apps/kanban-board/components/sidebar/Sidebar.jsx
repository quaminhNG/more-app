            ...
            <div className={`flex flex-col h-full w-64 pr-4 ${isMobile ? "pl-6 py-6" : ""} transition-opacity duration-300 ${isOpen ? "opacity-100" : "opacity-0"}`}>
                <div className="flex flex-row items-center justify-between pb-4">
                    <div className="flex flex-row gap-2 items-center">
                        ...
                        <span className="text-xl font-medium cursor-pointer">CRM System</span>
                    </div>
                ...
                <div className="mt-auto pt-6 flex flex-col gap-3">
                    ...
                    <Link to="/" className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 hover:shadow-lg transition-all focus:ring-2 focus:ring-indigo-500 shadow-sm border border-indigo-500/50">
